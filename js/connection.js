...
connection.connect((err) => {
  ...
  $queryString = "SELECT correo, clave FROM usuario WHERE correo = ? AND clave = ?";
...
document.querySelector('#btnRegister').onclick = function(){
    ...
    if(nameUser == "" || emailNewUser == "" || codePass == "" || !validateEmail){
...
connection.connect((err) => {
    ...
    $queryString = "INSERT INTO usuario (nombre, correo, usuario, clave) VALUES (?,?,?,?)";
